...
| `superchat` | a pinned **Remark** (level 1) / **Observation** (level 2) box |
...
| `authors[]` (`name`/`affiliation`/`corresponding`) | `streamer_uname` (shown as a lone author line) |
